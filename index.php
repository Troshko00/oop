          ...
          <div class="container">
            <div class="navbar-header">
              ...
              <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target=".navbar-collapse">
                ...
                <a href="registration.php" title="Зарегистрироваться">
                    <div id="btn">
                        Регистрация
                    </div>
...
<div id="works"  class=" clearfix grid"> 
    <figure class="effect-oscar  wowload fadeIn">
        ...
        <figcaption>
            ...
            <a href="cinema.php">View more</a></p>
        </figcaption>
    </figure>
     <figure class="effect-oscar  wowload fadeInUp">
        ...
        <figcaption>
            <h2>Sport</h2>
            <p><br>
            <a href="sport.php">View more</a></p>           
        </figcaption>
    </figure>
     <figure class="effect-oscar  wowload fadeInUp">
        ...
        <figcaption>
            <h2>Restaurants</h2>
            <p><br>
            <a href="restaurants.php">View more</a></p>            
        </figcaption>
    </figure>
     <figure class="effect-oscar  wowload fadeInUp">
        ...
        <figcaption>
            <h2>Theater</h2>
            <p><br>
            <a href="theater.php">View more</a></p>             
        </figcaption>
    </figure>
     <figure class="effect-oscar  wowload fadeInUp">
        ...
        <figcaption>
            <h2>Concert</h2>
            <p><br>
            <a href="concert.php">View more</a></p>              
        </figcaption>
    </figure>
    ...
    <figure class="effect-oscar  wowload fadeInUp">
        ...
        <figcaption>
            <h2>Festival</h2>
           <p><br>
            <a href="festival.php">View more</a></p>             
        </figcaption>
    </figure>
    <figure class="effect-oscar  wowload fadeInUp">
        ...
        <figcaption>
            <h2>Museum</h2>
            <p><br>
            <a href="museum.php">View more</a></p>              
        </figcaption>
    </figure>
    <figure class="effect-oscar  wowload fadeInUp">
        ...
        <figcaption>
            <h2>Water Park</h2>
            <p><br>
            <a href="waterpark.php">View more</a></p>             
        </figcaption>
    </figure>
